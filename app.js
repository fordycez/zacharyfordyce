import { createClient } from 'https://esm.sh/@supabase/supabase-js@2'
  ...
  const bucketName = 'secure'  // private bucket
  ...
  async function login() {
    ...
    const msg = error ? `Error: ${error.message}` : 'Magic link sent! Check your email.'
